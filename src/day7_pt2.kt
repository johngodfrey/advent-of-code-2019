...
fun getOutputFromFeedbackLoop(tape: String): Int {
    ...
    val everyCombinationOfPhaseSettings = getEveryCombinationOfCharacters("56789")
    val amplifiers = "98765".map {
        getContextForPhaseSetting(it, program)
    }
    return processContexts(amplifiers)
}
...
fun processContexts(amplifiers: List<Context>): Int {
    ...
    println("After rotating, rotatingList: $rotatingList")
